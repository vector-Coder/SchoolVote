...
public class JsonResult<T> {
    ...
    public JsonResult(String message, T data, Integer code, boolean result) {
    ...
    public JsonResult(String message, Integer code, boolean result) {
        this.message = message;
        this.code = code;
        this.result = result;
    }
